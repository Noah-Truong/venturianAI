...
export const metadata: Metadata = {
  title: "Security",
  description:
    "Venturian AI's security posture: SOC 2 Type II certified, end-to-end encryption, responsible disclosure program, and student data handling practices.",
  alternates: { canonical: "https://venturian.way-marketing.com/security" },
};
          ...
          <div className="max-w-6xl mx-auto px-6">
            <FadeIn>
              ...
              <p className="text-lg text-[#52525B] leading-relaxed max-w-[55ch]">
                Venturian handles student data with the same care enterprise infrastructure teams use.
        ...
        <section className="py-24 border-b border-[#D4D4D8]/50">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <FadeIn delay={0.05}>
                <article className="rounded-xl border border-[#D4D4D8]/60 bg-[#F4F4F5] p-8 flex flex-col gap-4">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-lg bg-[#0F766E]/10 flex items-center justify-center">
                      <ShieldCheck />
                    </div>
                    <h3 className="text-[#09090B] font-semibold">SOC 2 Type II</h3>
                  </div>
                  ...
                  <Link
                    ...
                    className="text-sm text-[#0F766E] hover:text-[#0D9488] transition-colors self-start"
                  >
              ...
              <FadeIn delay={0.1}>
                <article className="rounded-xl border border-[#D4D4D8]/60 bg-[#F4F4F5] p-8 flex flex-col gap-4">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-[#09090B] font-semibold">GDPR & CCPA compliant</h3>
                  </div>
                  <p className="text-sm text-[#52525B] leading-relaxed">
              ...
              {[
                ...
                <FadeIn key={label} delay={i * 0.07}>
                  <div className="bg-[#09090B] p-8 h-full flex flex-col gap-4">
                    ...
                    <p className="text-2xl font-semibold text-[#0F766E] font-mono">{value}</p>
                    <p className="text-sm text-[#52525B] leading-relaxed">{detail}</p>
                  </div>
                </FadeIn>
              ))}
            </div>
            ...
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 list-none" role="list">
              {[
                ...
                <FadeIn key={heading} delay={i * 0.07}>
                  <li className="rounded-xl border border-[#D4D4D8]/60 bg-[#F4F4F5] p-6 flex flex-col gap-3">
                    <h3 className="text-[#09090B] font-semibold text-sm">{heading}</h3>
          ...
          <div className="max-w-6xl mx-auto px-6">
            <FadeIn>
              <div className="max-w-2xl">
                ...
                <h2
                  className="text-3xl font-semibold text-[#09090B] mb-6"
                  style={{ textWrap: "balance" } as React.CSSProperties}
                >
                  Found something? Tell us first.
                </h2>
                <p className="text-[#52525B] leading-relaxed mb-8">
                  If you discover a security vulnerability in Venturian's systems, please give us a
                ...
                <div className="rounded-xl border border-[#D4D4D8]/60 bg-[#F4F4F5] p-6 flex flex-col gap-4 mb-8">
                  <p className="text-xs font-medium tracking-widest uppercase text-[#A1A1AA]">
                    In scope
                  </p>
                  <ul className="flex flex-col gap-2 list-none" role="list">
                    {[
                      ...
                      "Venturian dashboard (app.venturianai.com)",
                      "Venturian dashboard and API",
                      "Authentication and authorisation systems",
                    ].map((item) => (
                      <li key={item} className="flex items-start gap-2 text-sm text-[#52525B]">
                        <span className="text-[#0F766E] mt-0.5 shrink-0" aria-hidden="true">✓</span>
                        {item}
                      </li>
                    ))}
                  </ul>
...
function LockIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <rect x="5" y="11" width="14" height="10" rx="2" stroke="#0F766E" strokeWidth="1.5" />
      <path d="M8 11V7a4 4 0 018 0v4" stroke="#0F766E" strokeWidth="1.5" strokeLinecap="round" />
